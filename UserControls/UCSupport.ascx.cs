    ...
    public partial class UCSupport : System.Web.UI.UserControl
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //long[] rec = null;
                //byte[] status = null;
                //ConLine.com.panelesms.www.Send SmsPanel = new ConLine.com.panelesms.www.Send();
                ...
                bool SendResult = tools.SendEmail(MainBody, " تماس از کانلاین", Email, "sales@diamondgermany.com", "bidaad@gmail.com", "");
