<%@ Page Language="C#" StylesheetTheme="Edit" MasterPageFile="~/Admin/EditPopup.master"
    AutoEventWireup="true" Inherits="ProductGaranties_EditProductGaranties"
    Title="ProductGaranties" Codebehind="EditProductGaranties.aspx.cs" %>
                                        ...
                                        <tr>
                                            <td>
                                                <table class="EditRow">
                                                    <tr>
                                                        <td class="cCtrl">
                                                            <AKP:Combo ID="cboHCGarantyCode" jas="1" runat="server" />
                                                        </td>
                                                        <td class="cLabel">
                                                            <asp:Label ID="lblHCGarantyCode" runat="server" Text="گارانتی:"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
