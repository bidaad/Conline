...
function XMLBrowse(BID, SMode) {
    ...
    this.DoFilter = function (ConditionCode, Keyword) {
        ...
        //        this.BoardObj.innerHTML = 'جستجو روي ستون ' + ClassObj.MainObj.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[this.ActiveCell].getAttribute("msprop:Caption") + ' براي کلمه ' + Keyword
        //        this.CloseFilter();
    ...
    this.GenerateTable = function () {
        ...
        //ClassObj.CreateRow(ClassObj.FilterTable , 9 , 'بين')
