    ...
    public partial class Shipping : System.Web.UI.Page
    {
        ...
        protected void btnSaveContinue_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!rbPost.Checked && !rbPeik.Checked)
                {
                    msgMessage.MessageTextMode = AKP.Web.Controls.Common.MessageMode.Error;
                ...
                if (CurAddress.CityCode != 124 && rbPeik.Checked)
                {
                    msgMessage.MessageTextMode = AKP.Web.Controls.Common.MessageMode.Error;
                    msgMessage.Text = "امکان ارسال پیک فقط برای تهران وجود دارد. لطفا شیوه ارسال را به پست تغییر دهید";
                    return;
                }
