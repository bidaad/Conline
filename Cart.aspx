<%@ Page Language="C#" AutoEventWireup="True" Title="سفارش کالا" EnableEventValidation="false"
    MasterPageFile="~/MainRoot.Master" CodeBehind="Cart.aspx.cs" Inherits="ConLine.Order" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="CP1">
    ...
    <div class="">
        <div class="">
            ...
            <div>
                <asp:ImageButton ID="btnNext1" ImageUrl="~/images/spacer.gif" CssClass="FinalizePurchase"
                    OnClientClick="Hide(this)" Text="خرید" runat="server" OnClick="btnFinalizePurchase_Click">
                </asp:ImageButton>
                <asp:ImageButton ID="ImageButton1" ImageUrl="~/images/spacer.gif" CssClass="ContinuePurchase"
