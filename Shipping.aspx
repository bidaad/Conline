<%@ Page Language="C#" AutoEventWireup="True" Title="سفارش کالا" EnableEventValidation="false"
    MasterPageFile="~/Master1Col.Master" CodeBehind="Shipping.aspx.cs" Inherits="ConLine.Shipping" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="CP1">
                ...
                <div class="modal-body">
                    <table align="center" cellpadding="3" cellspacing="0" dir="rtl" class="tbWide">
                        ...
                        <tr>
                            ...
                            <td align="right" style="direction: ltr;">
                                <div class="input-group">
                                    <input id="txtNewAddressCellPhone" class="form-control" style="width: 180px; font-family: tahoma;"
                                        type="text" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="right" style="direction: ltr;">
                                <div class="input-group">
                                    <input id="txtNewAddressTel" class="form-control" style="width: 180px; font-family: tahoma;"
                                        type="text" />
                                </div>
                            </td>
                        </tr>
    ...
    <div class="">
        <div class="">
            ...
            <div id="btnShowAddressForm" class="AddNewAddress">
            </div>
            <div>
            ...
            <div>
                <div class="AddressCont">
                    <table class="tblDeliverTypes">
                        <tr>
                            <td class="TDRadio text-center">
                                <asp:RadioButton ID="rbPost" Checked="true" GroupName="DeliverType" runat="server" />
                            </td>
                            <td class="TDText">
                                پست
                            </td>
                ...
                <div class="AddressCont">
                    <table class="tblDeliverTypes">
                        <tr>
                            <td class="TDRadio text-center">
                                <asp:RadioButton ID="rbPeik" GroupName="DeliverType" runat="server" />
                            </td>
                            <td class="TDText">
                                پیک
                            </td>
                    ...
                    <div class="Marginer1">
                        <div class="OrderForm" style="text-align: right;">
                            <div style="text-align: left; padding-left: 15px;">
                                <asp:ImageButton ID="btnSaveContinue" ImageUrl="~/images/spacer.gif" OnClientClick="Hide(this)"
