    ...
    public partial class Order : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (ProductCode != 0)
                {
                    ...
                    {
                        int ItemCount = 1;
                        int FinalCount = AddToOrders(ProductCode, ItemCount, CurProduct.FaTitle, (int)CurProduct.Price, CurProduct.Weight, CurProduct.EnTitle);
        ...
        public string GetStatus(Object obj)
        {
            ...
            catch (Exception err)
            {
                ...
                bool SenderrResult = tools.SendEmail(errMailBody, " خطا در  کانلاین ", "admin@ConLine.ir", "bidaad@gmail.com", "", "");
                return "";
            }
        }
        ...
        private int AddToOrders(int ProductCode, int ItemCount, string ProductName, int ProductPrice, int ProductWeight, string EnTitle)
        {
